...
MapNavigationToolbar.prototype = {
        ...
        _initializer: function() {
            ...
            if (this.minValue > this.maxValue) { var x = this.minValue;
        ...
        _createSlider: function() {
            with(this) {
                ...
                _self._ticks.onclick = function(event) { _moveTo(event);
                        _moveEnd(event); }
                    /* 滑动条-已选中标尺 */
                ...
                _self._ticksSel.onclick = function(event) { _moveTo(event);
                        _moveEnd(event); }
                    /* 滑动条-滑块 */
