...
! function (a, b) {
    ...
    function o(a) {
        var b = a[0],
            c = a[1];
        return [l(b / Y) - 360 * Math.floor((l(b / Y) + 180) / 360), l(Math.PI / 2 - 2 * Math.atan(Math.exp(-1 * c / Y)))]
    }

    function p(a) {
        var b = a[0],
            c = Math.max(Math.min(a[1], 89.99999), -89.99999);
        return [m(b) * Y, Y / 2 * Math.log((1 + Math.sin(m(c))) / (1 - Math.sin(m(c))))]
    }

    function q(a, b, c) {
        if ("Point" === a.type) a.coordinates = b(a.coordinates);
        else if ("Feature" === a.type) a.geometry = q(a.geometry, b, !0);
        else if ("FeatureCollection" === a.type)
            for (var d = 0; d < a.features.length; d++) a.features[d] = q(a.features[d], b, !0);
        else if ("GeometryCollection" === a.type)
            for (var e = 0; e < a.geometries.length; e++) a.geometries[e] = q(a.geometries[e], b, !0);
        else a.coordinates = n(a.coordinates, b);
        return c || b === p && (a.crs = _), b === o && delete a.crs, a
    }
    ...
    function C(a, b) {
        for (var c = 0; c < a.length - 1; c++)
            for (var d = 0; d < b.length - 1; d++)
                if (B(a[c], a[c + 1], b[d], b[d + 1])) return !0;
        return !1
    }
        ...
        for (var c = 0; c < b.length; c++)
            for (var d = b[c], e = 0; e < d.length - 1; e++)
                for (var f = 0; f < a.length - 1; f++)
                    if (B(d[e], d[e + 1], a[f], a[f + 1])) return !0;
        return !1
    }
    ...
    function F(a, b) {
        for (var c = 0; c < b.length; c++) return D(a, b[c]) ? !0 : !1
    }
    ...
    function H(a, b) {
        for (var c = 0; c < a.length; c++) return G(a[c], b) ? !0 : !1
    }

    function I(a) {
        for (var b = [], c = 0; c < a.length; c++) {
            var d = a[c].slice();
            J(d[0], d[d.length - 1]) === !1 && d.push(d[0]), b.push(d)
        }
        return b
    }
    ...
    function M(b) {
        ...
        if (b && "Point" === b.type && b.coordinates) c(this, b);
        else if (b && a(b)) this.coordinates = b;
        else {
    ...
    function N(b) {
        if (b && "MultiPoint" === b.type && b.coordinates) c(this, b);
        else {
    ...
    function O(b) {
        if (b && "LineString" === b.type && b.coordinates) c(this, b);
        else {
    ...
    function P(b) {
        if (b && "MultiLineString" === b.type && b.coordinates) c(this, b);
        else {
    ...
    function Q(b) {
        if (b && "Polygon" === b.type && b.coordinates) c(this, b);
        else {
    ...
    function R(b) {
        if (b && "MultiPolygon" === b.type && b.coordinates) c(this, b);
        else {
    ...
    function T(b) {
        if (b && "FeatureCollection" === b.type && b.features) c(this, b);
        else {
    ...
    function U(b) {
        if (b && "GeometryCollection" === b.type && b.geometries) c(this, b);
        else if (a(b)) this.geometries = b;
        else {
    ...
    function V(a, b, c) {
        ...
        return f.coordinates = I(f.coordinates), s(f)
    }
    ...
    var X = {},
        ...
        bb = ["length"];
    return L.prototype.toMercator = function () {
        return r(this)
    }, L.prototype.toGeographic = function () {
        return s(this)
    }, L.prototype.envelope = function () {
        return k(this)
    }, L.prototype.bbox = function () {
        return d(this)
    }, L.prototype.convexHull = function () {
        var a, b, c = [];
        ...
        var a = {};
        for (var b in this) this.hasOwnProperty(b) && -1 === bb.indexOf(b) && (a[b] = this[b]);
        return a.bbox = d(this), a
    }, L.prototype.contains = function (a) {
        return new L(a).within(this)
    }, L.prototype.within = function (a) {
        var b, c, d;
        if ("Point" === a.type && "Point" === this.type) return J(this.coordinates, a.coordinates);
        ...
        if (("LineString" === a.type || "MultiPoint" === a.type) && "Point" === this.type)
            for (c = 0; c < a.coordinates.length; c++) {
                ...
                if (J(this.coordinates, a.coordinates[c])) return !0
            }
        if ("Polygon" === a.type) {
            if ("Polygon" === this.type) {
                if (a.coordinates.length === this.coordinates.length)
                    for (c = 0; c < this.coordinates.length; c++)
                        if (K(this.coordinates[c], a.coordinates[c])) return !0;
                return this.coordinates.length && A(a.coordinates, this.coordinates[0][0]) ? !E(I(this.coordinates), I(a.coordinates)) : !1
            }
            if ("Point" === this.type) return A(a.coordinates, this.coordinates);
            if ("LineString" === this.type || "MultiPoint" === this.type) {
                if (!this.coordinates || 0 === this.coordinates.length) return !1;
                for (c = 0; c < this.coordinates.length; c++)
                    if (A(a.coordinates, this.coordinates[c]) === !1) return !1;
                return !0
            }
            if ("MultiLineString" === this.type) {
                for (c = 0; c < this.coordinates.length; c++) {
                    var f = new O(this.coordinates[c]);
        ...
        if ("MultiPolygon" === a.type) {
            if ("Point" === this.type) {
                if (a.coordinates.length)
                    for (c = 0; c < a.coordinates.length; c++)
                        if (b = a.coordinates[c], A(b, this.coordinates) && E(this.coordinates, a.coordinates) === !1) return !0;
                return !1
            }
            if ("Polygon" === this.type) {
                for (c = 0; c < this.coordinates.length; c++)
                    if (a.coordinates[c].length === this.coordinates.length)
                        for (j = 0; j < this.coordinates.length; j++)
                            if (K(this.coordinates[j], a.coordinates[c][j])) return !0;
                if (G(this.coordinates, a.coordinates) === !1 && a.coordinates.length) {
                    for (c = 0; c < a.coordinates.length; c++) b = a.coordinates[c], d = A(b, this.coordinates[0][0]) === !1 ? !1 : !0;
                    return d
                }
                ...
                for (c = 0; c < a.coordinates.length; c++) {
                    ...
                    if ("MultiLineString" === this.type) {
                        for (c = 0; c < this.coordinates.length; c++) {
                            var i = new O(this.coordinates[c]);
        ...
        if ("LineString" === this.type) {
            if ("LineString" === a.type) return C(this.coordinates, a.coordinates);
            if ("MultiLineString" === a.type) return D(this.coordinates, a.coordinates);
            if ("Polygon" === a.type) return D(this.coordinates, I(a.coordinates));
            if ("MultiPolygon" === a.type) return F(this.coordinates, a.coordinates)
        } else if ("MultiLineString" === this.type) {
            if ("LineString" === a.type) return D(a.coordinates, this.coordinates);
            if ("Polygon" === a.type || "MultiLineString" === a.type) return E(this.coordinates, a.coordinates);
            if ("MultiPolygon" === a.type) return G(this.coordinates, a.coordinates)
        } else if ("Polygon" === this.type) {
            if ("LineString" === a.type) return D(a.coordinates, I(this.coordinates));
            if ("MultiLineString" === a.type) return E(I(this.coordinates), a.coordinates);
            if ("Polygon" === a.type) return E(I(this.coordinates), I(a.coordinates));
            if ("MultiPolygon" === a.type) return G(I(this.coordinates), a.coordinates)
        } else if ("MultiPolygon" === this.type) {
            if ("LineString" === a.type) return F(a.coordinates, this.coordinates);
            if ("Polygon" === a.type || "MultiLineString" === a.type) return G(I(a.coordinates), this.coordinates);
            if ("MultiPolygon" === a.type) return H(this.coordinates, a.coordinates)
        } else if ("Feature" === this.type) {
            var d = new L(this.geometry);
            return d.intersects(a)
        }
        return b("Type " + this.type + " to " + a.type + " intersection is not supported by intersects"), !1
    }, M.prototype = new L, M.prototype.constructor = M, N.prototype = new L, N.prototype.constructor = N, N.prototype.forEach = function (a) {
        for (var b = 0; b < this.coordinates.length; b++) a.apply(this, [this.coordinates[b], b, this.coordinates]);
        return this
    }, N.prototype.addPoint = function (a) {
        return this.coordinates.push(a), this
    }, N.prototype.insertPoint = function (a, b) {
        return this.coordinates.splice(b, 0, a), this
    }, N.prototype.removePoint = function (a) {
        return "number" == typeof a ? this.coordinates.splice(a, 1) : this.coordinates.splice(this.coordinates.indexOf(a), 1), this
    }, N.prototype.get = function (a) {
        return new M(this.coordinates[a])
    }, O.prototype = new L, O.prototype.constructor = O, O.prototype.addVertex = function (a) {
        return this.coordinates.push(a), this
    }, O.prototype.insertVertex = function (a, b) {
        return this.coordinates.splice(b, 0, a), this
    }, O.prototype.removeVertex = function (a) {
        return this.coordinates.splice(a, 1), this
    }, P.prototype = new L, P.prototype.constructor = P, P.prototype.forEach = function (a) {
        for (var b = 0; b < this.coordinates.length; b++) a.apply(this, [this.coordinates[b], b, this.coordinates])
    }, P.prototype.get = function (a) {
        return new O(this.coordinates[a])
    }, Q.prototype = new L, Q.prototype.constructor = Q, Q.prototype.addVertex = function (a) {
        return this.coordinates[0].push(a), this
    }, Q.prototype.insertVertex = function (a, b) {
        return this.coordinates[0].splice(b, 0, a), this
    }, Q.prototype.removeVertex = function (a) {
        return this.coordinates[0].splice(a, 1), this
    }, Q.prototype.close = function () {
        this.coordinates = I(this.coordinates)
    }, R.prototype = new L, R.prototype.constructor = R, R.prototype.forEach = function (a) {
        for (var b = 0; b < this.coordinates.length; b++) a.apply(this, [this.coordinates[b], b, this.coordinates])
    }, R.prototype.get = function (a) {
        return new Q(this.coordinates[a])
    }, R.prototype.close = function () {
        var a = [];
        return this.forEach(function (b) {
            a.push(I(b))
        }), this.coordinates = a, this
    }, S.prototype = new L, S.prototype.constructor = S, T.prototype = new L, T.prototype.constructor = T, T.prototype.forEach = function (a) {
